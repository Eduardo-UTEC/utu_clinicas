...
public class ConsultaFrame extends JInternalFrame {
  ...
  private void initComponents() {
    ...
    top.setBorder(BorderFactory.createTitledBorder(
        ...
        "<html><b>Seleccionar doctor</b></html>",
    ...
    center.setBorder(BorderFactory.createTitledBorder(
        BorderFactory.createEtchedBorder(),
        "<html><b>Reservas pendientes</b></html>",
        TitledBorder.LEFT, TitledBorder.TOP));
    tbl = new JTable();
    ...
    bottom.setBorder(BorderFactory.createTitledBorder(
        BorderFactory.createEtchedBorder(),
        "<html><b>Completar consulta</b></html>",
        TitledBorder.LEFT, TitledBorder.TOP));
    ...
    cboDoctor.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent e) { loadPendientes(); }
    });
    btnRefrescar.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent e) { loadPendientes(); }
    });
    btnConfirmar.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent e) { onConfirmar(); }
    });
    tbl.getSelectionModel().addListSelectionListener(new javax.swing.event.ListSelectionListener() {
      public void valueChanged(javax.swing.event.ListSelectionEvent e) {
        if (!e.getValueIsAdjusting()) onPick();
      }
    });
  }
    ...
    try {
      ...
      for (Reserva r : list) {
        ...
        String nombre = p != null
            ? String.format("%s %s (%s)", nullSafe(p.getNom1()), nullSafe(p.getApe1()), nullSafe(p.getCedula()))
      ...
      // aplicar renderer dd/MM/yyyy HH:mm a "Inicio" (índice visible 2 tras ocultar ID)
  ...
  private void onPick() {
    ...
    if (viewRow < 0) { reservaSeleccionada = null; return; }
    ...
    if (idObj == null) { reservaSeleccionada = null; return; }
